...
from model_promptmedts_DD import PromtptMedTS
import torch
import json
import copy
import time
...
if __name__ == '__main__':
    ...
    model = PromtptMedTS(trunction_len, Freeze_t5coder = Freeze_t5coder, Freeze_TST = Freeze_TST, num_query_tokens = num_query_tokens,decoder_model_id = decoder_model_id,base_model_id = base_model_id)  # doctest: +IGNORE_RESULT
